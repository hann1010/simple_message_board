"""
Django settings for simple_message_board project.
...
SECRET_KEY = 'django-insecure-+gja@h)lc9y1^f0e@gvh^p%cg4iv_*mck6s2_p)@+vpg@q8@@@'
...
ROOT_URLCONF = 'simple_message_board.urls'
...
WSGI_APPLICATION = 'simple_message_board.wsgi.application'
...
LOGIN_REDIRECT_URL = 'message-board_home'
LOGIN_URL = 'login'
